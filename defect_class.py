...
import pandas as pd
import copy
from defect_prep import *
from sklearn.preprocessing import StandardScaler
from util_defect import *
...
class LORMIKA:
        ...
        # file initialization
            # file creation
            #  make the required variables, class variables
    ...
    def make_nam_file_MO(self):
        ...
        # catCol_index_df = []
        # test_col_names = list(cases)
        # for col_n in test_col_names:
        #     if col_n in categorical_vars:
        #         catCol_index_df.append(cases.columns.get_loc(col_n))
        ...
        outF = self.__path_data + '/data_MO/dilini/' + nam_d
        nam = open(outF, "w")
    ...
    def instance_generation(self):
        ...
        for rd in range(1, rounds + 1):
            ...
            print(list(self.__train_set), "columns")
            ...
            print(self.__continuous_vars,"ontinuous")
            print(type(self.__continuous_vars))
            ...
            for count, case in cases_normalize.iterrows():
                ...
                train_class_neigh = self.__train_class[self.__train_class.index.isin(final_neighbours_similarity_df.index)]
                ...
                nameF = self.__path_data + '/data_MO/dilini/' + self.__d_name + '_' + str(case.name) + '_' + str(test_num) + '_' + str(
...
def run_single_dataset():
    ...
    for dataset_kw in datasets_list:
        ...
        for nb, black in enumerate(model_load):
            ...
            lormika_algo = LORMIKA(**model_kwargs)
            lormika_algo.run_sequence()
